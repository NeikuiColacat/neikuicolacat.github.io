...
![picture 0](/assets/img/b0868bc94dd3958745c1077df1f4689a03e866049cca05e2106c92d34da7e3fa.png)  

## 主流image generation模型常见架构

![picture 1](/assets/img/5ac40bd1bc5e85fe2c0491d3b6351ec85bf97311f3bf39d75d2cfb700d671352.png)  

note that, Generation Model一般用diffusion model来做

## 如何将VAE和diffusion 串联理解起来

![picture 2](/assets/img/a90d15f7c7361365730ae7d4a3de7d7c92a7b8999f01a1380ba16ecfb2089b4e.png)  
...
![picture 3](/assets/img/e6a821b2542f91804bb19f8be2e8e3b3913e2828ce069edae656d2a817383cd8.png)  

### decoding 过程

![picture 4](/assets/img/df0c6b24fdd66d91b932e28bcac6d4ad1322633ac8a2d91da4c28ac38d3423cf.png)  

---

生成模型在做sampling的时候并不会选取几率最大的那个prediction 。 例如在GPT中如果这么做，那么就会一直重复说一样的话

![picture 5](/assets/img/7171ac674bcc54f9ccf3ce2e45db4b85f0de2209f01eac7760e4d8d8b785afb0.png)  

同理对于diffusion model来说，我们也需要随机的sampling

![picture 6](/assets/img/038545a0426921ba6f92ce6ea5626f77143473c6f75a66a04afb2ffb81a7bde6.png)  

![picture 7](/assets/img/a8494b4439a200f8dd6da1d046547418451bb97c1eab3dfa2c531ebff8918202.png)  

## Latent Diffusion Models

使用latent space中采样的噪声来迭代去噪

![picture 8](/assets/img/2e2721b8c2b39cff87cd0d045dcd9ba30f43257cbc8507d2bc5da1b90268e51a.png)  
...
![picture 10](/assets/img/f3373d524c197184402588a90a3f11a458259926ca3ef75b61adb1098af77df0.png)  

引导方向 = 条件模型的梯度 - 无条件模型的梯度

## ECGTwin

![picture 9](/assets/img/e1b8c0143aa055939b39b97eccc12d790a9d9cb9cd578bb8fdeeb4ede3593541.png)  
...
### 问题1 ：迁移到跨模态领域，我的base vector如何设计

### 问题2 : 使用什么样的文本编码器来统一训练
...
![picture 11](/assets/img/1c35e40625c0025357b758e6d9e85ddf256fe50b7d05b9bd12c9b3c4e480a179.png)  
